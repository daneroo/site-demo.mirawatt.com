...
<div id="logo">
<!-- I know this is bad but couldn't fiure it out
  should be some div, with right size, and proper background...
-->
<a href="<?php echo get_option('home'); ?>">
<img style="margin-top:-15px" src="wp-content/themes/pixel-mirawatt/images/mirawatt-wp-pixel-logo-400x75-trans.png" >
</a>
<!--
